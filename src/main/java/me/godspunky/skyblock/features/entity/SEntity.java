...
import me.godspunky.skyblock.features.entity.end.EndermanStatistics;
import me.godspunky.skyblock.features.entity.nms.SNMSEntity;
...
public class SEntity // 3, 4, 5
{
    ...
    public SEntity(Location location, SEntityType specType, Object... params) {
        ...
        if (this.entity instanceof org.bukkit.entity.Ageable) {
            if (genericInstance instanceof me.godspunky.skyblock.features.entity.Ageable && ((me.godspunky.skyblock.features.entity.Ageable) genericInstance).isBaby())
