...
public class BonzoBossAbility {

    public static void shoot(LivingEntity p) {
        ...
        final int i = Bukkit.getScheduler().scheduleSyncRepeatingTask(Skyblock.getPlugin(), (Runnable)new BonzoAbilityRun(stand, p, vecTo), 0L, 1L);
        new BukkitRunnable() {
            int type;
        ...
        new BukkitRunnable() {
            public void run() {
                BonzoAbilityRun.cancel(i, stand);
            }
