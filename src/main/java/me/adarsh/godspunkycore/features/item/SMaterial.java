...
import me.adarsh.godspunkycore.features.item.armor.cheaptuxedo.CheapTuxedoSet;
...
import me.adarsh.godspunkycore.features.item.armor.zombie.ZombieSet;
...
public enum SMaterial {
    ...
    public static ZombieSet Zombie_Set = registerArmorSet(ZombieSet.class);
    public static CheapTuxedoSet CHEAPTUXEDO_SET = registerArmorSet(CheapTuxedoSet.class);
