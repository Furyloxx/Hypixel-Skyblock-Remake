...
public class ItemCollection {
    ...
    public static final ItemCollection WHEAT = new ItemCollection("Wheat",
            ...
            SMaterial.WHEAT,
            (short) 0,
            new ItemCollectionRewards(50, new ItemCollectionUpgradeReward("Wheat Minion Recipe", ChatColor.BLUE)),
            new ItemCollectionRewards(100, new ItemCollectionUpgradeReward("Enchanted Book (Harvesting V) Recipe", ChatColor.GREEN)),
            ...
            new ItemCollectionRewards(500, new ItemCollectionUpgradeReward("Farming Talisman Recipe", ChatColor.GRAY)),
            new ItemCollectionRewards(1000, new ItemCollectionUpgradeReward("Enchanted Bread Recipe", ChatColor.GRAY)),
            new ItemCollectionRewards(2500, new ItemCollectionUpgradeReward("Farming Island Recipe", ChatColor.GRAY)),
            new ItemCollectionRewards(10000, new ItemCollectionUpgradeReward("Enchanted Hay Bale Recipe", ChatColor.GREEN), new ItemCollectionUpgradeReward("Small Agronomy Sack Recipe", ChatColor.GREEN)),
            new ItemCollectionRewards(15000, new ItemCollectionUpgradeReward("Medium Agronomy Sack Recipe", ChatColor.BLUE)),
            ...
            new ItemCollectionRewards(50000, new ItemCollectionUpgradeReward("Large Agronomy Recipe", ChatColor.DARK_PURPLE)),
            new ItemCollectionRewards(100000, new ItemCollectionUpgradeReward("Tightly-Tied Hay Bale Recipe", ChatColor.BLUE), new ItemCollectionUpgradeReward("Enchanted Large Agronomy Sack Recipe", ChatColor.DARK_PURPLE)));
    ...
    public static final ItemCollection MELON = new ItemCollection("Melon",
            ...
            new ItemCollectionRewards(250),
            new ItemCollectionRewards(500),
            new ItemCollectionRewards(120),
            new ItemCollectionRewards(5000),
            new ItemCollectionRewards(1500),
            new ItemCollectionRewards(2500),
            new ItemCollectionRewards(50000),
            new ItemCollectionRewards(100000),
            new ItemCollectionRewards(250000));
    ...
    public static final ItemCollection POTATO = new ItemCollection("Potato",
            ...
            new ItemCollectionRewards(200),
            new ItemCollectionRewards(500),
            new ItemCollectionRewards(1800),
            new ItemCollectionRewards(5000),
            new ItemCollectionRewards(10000),
            new ItemCollectionRewards(25000),
            new ItemCollectionRewards(50000),
