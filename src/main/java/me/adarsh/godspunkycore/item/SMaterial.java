...
import me.adarsh.godspunkycore.item.accessory.*;
...
import me.adarsh.godspunkycore.item.armor.vanilla.chainmail.ChainmailLeggings;
import me.adarsh.godspunkycore.item.armor.vanilla.diamond.DiamondBoots;
import me.adarsh.godspunkycore.item.armor.vanilla.diamond.DiamondChestplate;
import me.adarsh.godspunkycore.item.armor.vanilla.diamond.DiamondHelmet;
import me.adarsh.godspunkycore.item.armor.vanilla.diamond.DiamondLeggings;
import me.adarsh.godspunkycore.item.armor.vanilla.golden.GoldenBoots;
import me.adarsh.godspunkycore.item.armor.vanilla.golden.GoldenChestplate;
import me.adarsh.godspunkycore.item.armor.vanilla.golden.GoldenHelmet;
import me.adarsh.godspunkycore.item.armor.vanilla.golden.GoldenLeggings;
import me.adarsh.godspunkycore.item.armor.vanilla.iron.IronBoots;
import me.adarsh.godspunkycore.item.armor.vanilla.iron.IronChestplate;
import me.adarsh.godspunkycore.item.armor.vanilla.iron.IronHelmet;
import me.adarsh.godspunkycore.item.armor.vanilla.iron.IronLeggings;
import me.adarsh.godspunkycore.item.armor.vanilla.leather.LeatherBoots;
import me.adarsh.godspunkycore.item.armor.vanilla.leather.LeatherChestplate;
import me.adarsh.godspunkycore.item.armor.vanilla.leather.LeatherHelmet;
import me.adarsh.godspunkycore.item.armor.vanilla.leather.LeatherLeggings;
import me.adarsh.godspunkycore.item.axe.vanilla.*;
import me.adarsh.godspunkycore.item.bow.Bow;
import me.adarsh.godspunkycore.item.bow.EndStoneBow;
import me.adarsh.godspunkycore.item.bow.HurricaneBow;
import me.adarsh.godspunkycore.item.bow.MosquitoBow;
import me.adarsh.godspunkycore.item.dragon.old.*;
import me.adarsh.godspunkycore.item.dragon.protector.*;
import me.adarsh.godspunkycore.item.dragon.strong.*;
import me.adarsh.godspunkycore.item.dragon.superior.*;
import me.adarsh.godspunkycore.item.dragon.unstable.*;
import me.adarsh.godspunkycore.item.dragon.wise.*;
import me.adarsh.godspunkycore.item.dragon.young.*;
import me.adarsh.godspunkycore.item.enchanted.*;
import me.adarsh.godspunkycore.item.enchanting.EnchantedBook;
import me.adarsh.godspunkycore.item.entity.RevenantHorrorHead;
import me.adarsh.godspunkycore.item.exclusive.TestItem;
import me.adarsh.godspunkycore.item.exclusive.WheatCrystal;
import me.adarsh.godspunkycore.item.farming.*;
import me.adarsh.godspunkycore.item.foraging.*;
import me.adarsh.godspunkycore.item.hoe.vanilla.*;
import me.adarsh.godspunkycore.item.mining.*;
import me.adarsh.godspunkycore.item.oddities.*;
import me.adarsh.godspunkycore.item.orb.*;
import me.adarsh.godspunkycore.item.pet.EndermanPet;
import me.adarsh.godspunkycore.item.pet.GungaPet;
import me.adarsh.godspunkycore.item.pickaxe.vanilla.*;
import me.adarsh.godspunkycore.item.revenant.*;
import me.adarsh.godspunkycore.item.rune.*;
import me.adarsh.godspunkycore.item.shovel.vanilla.*;
import me.adarsh.godspunkycore.item.storage.*;
import me.adarsh.godspunkycore.item.sven.*;
import me.adarsh.godspunkycore.item.tarantula.*;
import me.adarsh.godspunkycore.item.weapon.*;
import me.adarsh.godspunkycore.item.weapon.vanilla.*;
