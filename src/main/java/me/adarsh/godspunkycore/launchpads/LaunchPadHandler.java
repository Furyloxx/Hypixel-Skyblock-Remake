package me.adarsh.godspunkycore.launchpads;
...
//not my code
    ...
    public LaunchPadHandler() {
        this.file = new File(Spectaculation.getPlugin(Spectaculation.class).getDataFolder() + File.separator + LAUNCHPAD_FILE_NAME);
...
//    }
    ...
    public void launch(Player player, String padName) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                if (to.distance(am.getLocation()) < 2.0 || this.xC > 200.0 || !onLaunchpad.contains(player)) {
                    ...
                    }.runTask(Spectaculation.getPlugin());
        ...
        }.runTaskTimerAsynchronously(Spectaculation.getPlugin(Spectaculation.class), 1L, 1L);
    }
